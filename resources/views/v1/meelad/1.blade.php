...
@section('content')
    @php
        $quickSummary = [
            'notes' => [
                'റ. അവ്വൽ മാസം <strong>ഖുർആനിലോ, സഹീഹ് ഹദീസ് പ്രകാരമോ, ഖലീഫമാരും സ്വഹാബികളും മുഖേനയോ, മദ്ഹബുകളുടെ
                    ഇമാമുമാർ മുഖേനയോ</strong> വിശുദ്ധ മാസം ആയി പറയപ്പെട്ടിട്ടില്ല.',
                'എങ്കിലും, ചരിത്രപരമായി <strong>പ്രവാചകൻ ﷺ ജനിച്ച മാസം</strong> എന്ന നിലയിലാണ് റ. അവ്വൽ മുസ്ലിം സമൂഹത്തിൽ
                പ്രസിദ്ധമായത്.',
            ],
