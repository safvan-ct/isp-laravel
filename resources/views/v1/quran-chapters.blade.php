    ...
    <main class="container">
        <header class="page-hero">
            <div class="text-center">
                <h5 class='text-primary fw-bold text-Playfair text-tr'>{{ __('app.quran_title') }}</h5>
                <p class='text-muted m-0'>Search, filter and jump by Juz — designed for calm, focused study.</p>
            </div>
        </header>
